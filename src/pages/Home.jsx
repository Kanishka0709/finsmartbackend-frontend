...
import financeImg from '../api/assets/finance-coins-chart.jpg'; // Add this import (save your uploaded image as finance-coins-chart.jpg in assets)
        ...
        <div className="hero-content-row d-flex align-items-center justify-content-between px-4 py-5" style={{ width: '100%', position: 'relative', zIndex: 2 }}>
          ...
          <div className="hero-content-left text-start">
            ...
            {/* <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1.2rem' }}>
              <img src={logo} alt="Finsmart Logo" style={{ width: 72, height: 72, borderRadius: 16, marginRight: 18, boxShadow: '0 4px 16px rgba(25, 118, 210, 0.18)' }} />
            ...
            <button className="btn hero-cta-btn swipe-btn animate__animated animate__pulse animate__infinite" onClick={() => window.location.href = '/login'}>
              Start Journey <FaArrowRight className="arrow" />
            </button>
          </div>
